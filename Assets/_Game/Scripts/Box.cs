...
public class Box : Characters
{
    ...
    public void OnMouseUp()
    {
        ...
        Moving(dir);
        GameController.instance.cake.GetComponent<Cake>().Moving(dir);
    }
